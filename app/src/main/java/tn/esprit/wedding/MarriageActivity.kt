...
class MarriageActivity : AppCompatActivity() {
    ...
    private fun postToList(){
            ...
            addToList("GoodWed est une app de planification de marriage unique",R.drawable.icooo)
            addToList("Gérer la liste d'invités, suivi des tâches, contrôle des coûts",R.drawable.icooo)
            addToList("Invitez votre conjoint et organisez votre mariage ensemble",R.drawable.icooo)
